						 		...
						 		if (!(scope.ngReadonly)) {
						 			$timeout(function () {
						 				var options = {
						 					...
						 					closeOnSelect: (angular.isDefined(scope.closeOnSelect)) ? scope.closeOnSelect : true,
		 		...
		 		link: function (scope, element) {
		 			...
		 			if (!(scope.ngReadonly)) {
		 				element.pickatime({
		 					...
		 					donetext: (angular.isDefined(scope.donetext)) ? scope.donetext : 'OK',
		 					cleartext: 'BORRAR',
		 					canceltext: 'CANCELAR',
